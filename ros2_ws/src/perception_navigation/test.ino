...
void setup()
{
  ...
  bucket_servo.attach(1);
  sweeper_servo.attach(2);
  ...
  RCCHECK(rclc_executor_add_subscription(&executor_sub, &subscriber_servo, &servo_msg, &subscription_callback_servo, ON_NEW_DATA));
