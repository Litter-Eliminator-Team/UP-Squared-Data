...
class KeystrokeListen:
    def __init__(self, name=None):
        ...
        self.pub_glyph = self.node.create_publisher(std_msgs.msg.String, 'glyphkey_pressed', 3)
        # todo: when ROS2 supports Enums, use them: https://github.com/ros2/rosidl/issues/260
        self.pub_code = self.node.create_publisher(std_msgs.msg.UInt32, 'key_pressed', 3)
